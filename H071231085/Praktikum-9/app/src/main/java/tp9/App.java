...
public class App extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Label userNameLabel = new Label("Username: Alya");
        Label userRiwayat = new Label("Sudiang, telkomas");
        userRiwayat.setStyle("-fx-font-weight: bold; -fx-font-sixe: 16px;");
        userNameLabel.setStyle("-fx-font-weight: bold; -fx-font-size: 16px;");
        // ImageView profileImageView = new ImageView(new Image(App.class.getResource("C:\\Users\\Kevin\\Documents\\AlgoKevin\\Tp9\\app\\src\\main\\resources\\style\\foto").toString()));
        ...
        VBox profileLayout = new VBox(20, profileLabel, userNameLabel, userRiwayat, backButton);
