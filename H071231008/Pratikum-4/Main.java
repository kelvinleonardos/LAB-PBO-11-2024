...
public class Main {
    ...
    private static void runApp() {
        ...
        switch (selectMenu) {
            case 1:
                ...
                showLoginMenu(listUser,listUserProfile);
                break;
            case 2:
    ...
    private static void showLoginMenu(ArrayList<User>listUser,ArrayList<Profile>listUserProfile) {
        // Halaman Login
        System.out.println("-------------------------");
        ...
        for (int i = 0; i < listUser.size(); i++) {
            if (username == listUser.get(i).getUsername()){
                userIndex = i;
                break;
            }
        ...
        if (userIndex != -1) {
            ...
            if (listUser.get(userIndex).getPassword(password).equals("false")) {
    ...
    private static void showRegisterMenu() {
        ...
        profile.Nama = fullName;
        profile.umur = age;
        profile.hobby = hobby;
        profile.nickName = StringUtils.nickchange(fullName);
    ...
    System.out.println(profile.Nama);
    System.out.println(profile.umur);
    System.out.println(profile.hobby);
    System.out.println(profile.nickName);
    }
}
